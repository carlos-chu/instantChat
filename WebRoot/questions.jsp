...
<body>
	<div class="navbar  navbar-fixed-top">
		<s:include
			value="%{#request.getContextPath()}/include/head_questions.jsp"></s:include>
		<!--页头 -->
	</div>
	<!--主内容开始-->
	<div id="container">
		...
		<div id="main">
			<div class="post photo">
				<span class="date"><h4 class="indexTitle titleFont">问题广场
					</h4> </span>
				...
				<div class="pagination pagination-centered">
					<ul>
						<s:if test="currentPageContext != null && currentPageContext > 1">
							<li><a href="<%=basePath%>questionsAction!initQuestions?page=1">
									首页</a>
							</li>
						</s:if><s:else>
						...
						<s:if test="totalPageContext < 3">
							<s:iterator value="new int[totalPageContext]" status="s">
						 		<li><a href="<%=basePath%>questionsAction!initQuestions?page=<s:property value="#s.index+1" />">
										<s:property value="#s.index+1" /></a>
								</li>
							</s:iterator>
						</s:if><s:elseif test="currentPageContext == 0 || currentPageContext == 1">
						 	<li><a href="<%=basePath%>questionsAction!initQuestions?page=1">1</a></li>
						 	<li><a href="<%=basePath%>questionsAction!initQuestions?page=2">2</a></li>
						 	<li><a href="<%=basePath%>questionsAction!initQuestions?page=3">3</a></li>
						 	<s:if test="totalPageContext > 3">
						 		<li><a href="<%=basePath%>questionsAction!initQuestions?page=4">...</a></li>
						 	</s:if>
						 </s:elseif><s:elseif test="currentPageContext != 1 && currentPageContext != 0">
						 	<li><a href="<%=basePath%>questionsAction!initQuestions?page=<s:property value="currentPageContext-1"/>">
										<s:property value="currentPageContext-1"/></a></li>
						 	<li><a href="<%=basePath%>questionsAction!initQuestions?page=<s:property value="currentPageContext"/>">
						...
						<s:if test="currentPageContext != 0 && currentPageContext < totalPageContext">
							<li><a href="<%=basePath%>questionsAction!initQuestions?page=<s:property value="totalPageContext"/>">末页</a>
							</li>
						</s:if><s:else>
