	...
	<div class="container-fluid">
		...
		<div class="nav-collapse collapse">
			<ul class="nav">
				...
				<li class="divider-vertical"></li>
				<li><a href="<%=basePath%>questionsAction!initQuestions">
					<i class="icon-question-sign"></i><strong
						class="text-info titleFont"> 问答广场</strong> </a>
				</li>
				<li class="divider-vertical"></li>
				<li class="active"><a href="<%=basePath%>usersAction!initUsers">
					<i class="icon-eye-open"></i><strong
						class="text-info titleFont"> 达人广场</strong> </a>
				</li>
				<li class="divider-vertical"></li>
				<li><a href="<%=basePath%>discussesAction!initDiscusses">
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown"><a class="dropdown-toggle titleFont"
						...
						<div class="dropdown-menu"
							...
							<form method="post"
								action="<%=basePath%>userLoginAction!loginUser.action"
